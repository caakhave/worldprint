...
| Agricultural water withdrawals (`ER.H2O.FWAG.ZS`) | passed | practice_eligible | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_practice_eligible |
| Agriculture value growth (`NV.AGR.TOTL.KD.ZG`) | passed | needs_review | 3 | 5 | 4 | 3 | 2 | 3.3 | keep_needs_review |
| Agriculture methane emissions (`EN.GHG.CH4.AG.MT.CE.AR5`) | passed | expert_only | 4 | 5 | 3 | 4 | 2 | 3.55 | review_ambiguity |
| Agriculture nitrous oxide emissions (`EN.GHG.N2O.AG.MT.CE.AR5`) | passed | expert_only | 4 | 5 | 3 | 4 | 2 | 3.55 | review_ambiguity |
| Agriculture value added (`NV.AGR.TOTL.ZS`) | passed | daily_eligible | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_daily_eligible |
| Agriculture value per worker (`NV.AGR.EMPL.KD`) | passed | expert_only | 3 | 5 | 4 | 4 | 2 | 3.55 | review_ambiguity |
...
| Cereal production (`AG.PRD.CREL.MT`) | passed | expert_only | 4 | 4 | 3 | 4 | 3 | 3.6 | keep_expert_only |
| Cereal yield (`AG.YLD.CREL.KG`) | passed | daily_eligible | 4 | 4 | 4 | 4 | 5 | 4.2 | keep_daily_eligible |
| Child overweight (`SH.STA.OWGH.ZS`) | held | practice_eligible | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Child stunting (`SH.STA.STNT.ZS`) | held | daily_eligible | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
...
| Compulsory education duration (`SE.COM.DURS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_daily_eligible |
| Container port traffic (`IS.SHP.GOOD.TU`) | passed | expert_only | 3 | 2 | 3 | 4 | 3 | 3.1 | keep_expert_only |
| Contraceptive use (`SP.DYN.CONU.ZS`) | held | practice_eligible | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Contributing family workers (`SL.FAM.WORK.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
...
| Female agricultural employment (`SL.AGR.EMPL.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female contributing family workers (`SL.FAM.WORK.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female employment-to-population ratio (`SL.EMP.TOTL.SP.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female industry employment (`SL.IND.EMPL.FE.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_daily_eligible |
| Female labor force participation (`SL.TLF.CACT.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female self-employed (`SL.EMP.SELF.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Women in senior management (`SL.EMP.SMGT.FE.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Female services employment (`SL.SRV.EMPL.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female unemployment (`SL.UEM.TOTL.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female vulnerable employment (`SL.EMP.VULN.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Female wage workers (`SL.EMP.WORK.FE.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
...
| Food exports share (`TX.VAL.FOOD.ZS.UN`) | passed | practice_eligible | 3 | 4 | 4 | 4 | 3 | 3.6 | keep_practice_eligible |
| Food imports share (`TM.VAL.FOOD.ZS.UN`) | passed | practice_eligible | 3 | 4 | 4 | 4 | 3 | 3.6 | keep_practice_eligible |
...
| Freshwater per person (`ER.H2O.INTR.PC`) | passed | daily_eligible | 4 | 4 | 5 | 4 | 3 | 4.0 | keep_daily_eligible |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | passed | expert_only | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_expert_only |
| GDP growth (`NY.GDP.MKTP.KD.ZG`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
...
| Gross capital formation (`NE.GDI.TOTL.ZS`) | passed | needs_review | 3 | 5 | 4 | 3 | 3 | 3.5 | keep_needs_review |
| Gross savings (`NY.GNS.ICTR.ZS`) | passed | expert_only | 3 | 5 | 4 | 4 | 2 | 3.55 | review_ambiguity |
| Health expenditure (`SH.XPD.CHEX.GD.ZS`) | passed | daily_eligible | 4 | 4 | 4 | 4 | 5 | 4.2 | keep_daily_eligible |
...
| Advanced-education labor force (`SL.TLF.ADVN.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Female-to-male labor force ratio (`SL.TLF.CACT.FM.ZS`) | passed | practice_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_practice_eligible |
| Labor force participation (`SL.TLF.CACT.ZS`) | passed | practice_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Labor force with secondary education (`SL.TLF.SECO.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Land under cereal production (`AG.LND.CREL.HA`) | passed | daily_eligible | 4 | 4 | 4 | 4 | 2 | 3.6 | review_ambiguity |
| Largest city share (`EN.URB.LCTY.UR.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_practice_eligible |
| Life expectancy (`SP.DYN.LE00.IN`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Livestock production index (`AG.PRD.LVSK.XD`) | passed | needs_review | 4 | 4 | 3 | 4 | 3 | 3.6 | keep_needs_review |
| Logistics infrastructure quality (`LP.LPI.INFR.XQ`) | passed | needs_review | 3 | 4 | 3 | 3 | 2 | 2.95 | keep_needs_review |
| Logistics performance (`LP.LPI.OVRL.XQ`) | passed | needs_review | 3 | 4 | 3 | 2 | 2 | 2.7 | keep_needs_review |
| Low-elevation coastal population (`EN.POP.EL5M.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 2 | 3.15 | review_ambiguity |
| Low-elevation land (`AG.LND.EL5M.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 2 | 3.15 | review_ambiguity |
| Lower secondary completion (`SE.SEC.CMPT.LO.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Lower secondary pupil-teacher ratio (`SE.SEC.ENRL.LO.TC.ZS`) | held | needs_review | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Logistics customs score (`LP.LPI.CUST.XQ`) | passed | needs_review | 3 | 4 | 3 | 2 | 2 | 2.7 | keep_needs_review |
| Logistics timeliness score (`LP.LPI.TIME.XQ`) | passed | needs_review | 3 | 4 | 3 | 2 | 3 | 2.9 | keep_needs_review |
| Logistics tracking score (`LP.LPI.TRAC.XQ`) | passed | needs_review | 3 | 4 | 3 | 2 | 2 | 2.7 | keep_needs_review |
| Male agricultural employment (`SL.AGR.EMPL.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male contributing family workers (`SL.FAM.WORK.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male employment-to-population ratio (`SL.EMP.TOTL.SP.MA.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Male industry employment (`SL.IND.EMPL.MA.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_expert_only |
| Male labor force participation (`SL.TLF.CACT.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 3 | 2 | 3.5 | keep_needs_review |
| Male self-employed (`SL.EMP.SELF.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male services employment (`SL.SRV.EMPL.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male unemployment (`SL.UEM.TOTL.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male vulnerable employment (`SL.EMP.VULN.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Male wage workers (`SL.EMP.WORK.MA.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
...
| Net primary enrollment (`SE.PRM.NENR`) | passed | needs_review | 3 | 1 | 4 | 2 | 3 | 2.65 | keep_needs_review |
...
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_daily_eligible |
| Open defecation (`SH.STA.ODFC.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Out-of-pocket health spending (`SH.XPD.OOPC.CH.ZS`) | passed | expert_only | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_expert_only |
| Out-of-school primary age (`SE.PRM.UNER.ZS`) | passed | daily_eligible | 3 | 4 | 4 | 4 | 3 | 3.6 | keep_daily_eligible |
| Out-of-school secondary age (`SE.SEC.UNER.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Own-account workers (`SL.EMP.OWAC.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Part-time employment (`SL.TLF.PART.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Female part-time employment (`SL.TLF.PART.FE.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | passed | needs_review | 3 | 3 | 4 | 3 | 3 | 3.2 | keep_needs_review |
...
| Poverty below $4.20 a day (`SI.POV.LMIC`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Average precipitation (`AG.LND.PRCP.MM`) | passed | daily_eligible | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_daily_eligible |
| Preprimary enrollment (`SE.PRE.ENRR`) | passed | needs_review | 3 | 2 | 4 | 3 | 3 | 3.05 | keep_needs_review |
| Primary education attainment (`SE.PRM.CUAT.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Primary completion (`SE.PRM.CMPT.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Primary education spending share (`SE.XPD.PRIM.ZS`) | held | needs_review | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Primary enrollment (`SE.PRM.ENRR`) | passed | needs_review | 3 | 4 | 4 | 3 | 3 | 3.35 | keep_needs_review |
| Female primary teachers (`SE.PRM.TCHR.FE.ZS`) | passed | daily_eligible | 3 | 4 | 4 | 4 | 3 | 3.6 | keep_daily_eligible |
| Primary enrollment gender parity (`SE.ENR.PRIM.FM.ZS`) | passed | needs_review | 3 | 2 | 4 | 2 | 3 | 2.8 | keep_needs_review |
| Primary gross intake (`SE.PRM.GINT.ZS`) | passed | practice_eligible | 3 | 1 | 4 | 4 | 3 | 3.15 | keep_practice_eligible |
| Private primary enrollment (`SE.PRM.PRIV.ZS`) | passed | needs_review | 3 | 3 | 4 | 3 | 3 | 3.2 | keep_needs_review |
| Female primary pupils (`SE.PRM.ENRL.FE.ZS`) | passed | practice_eligible | 3 | 1 | 4 | 3 | 3 | 2.9 | review_for_demotion |
| Primary repeaters (`SE.PRM.REPT.ZS`) | held | needs_review | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Primary-secondary gender parity (`SE.ENR.PRSC.FM.ZS`) | held | needs_review | 1 | 4 | 2 | 1 | 2 | 1.85 | hold_for_data |
| Private fixed capital formation (`NE.GDI.FPRV.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Private health spending share (`SH.XPD.PVTD.CH.ZS`) | passed | expert_only | 4 | 4 | 4 | 4 | 2 | 3.6 | review_ambiguity |
| Protected land (`ER.LND.PTLD.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 5 | 4.35 | keep_daily_eligible |
| Protected seas (`ER.MRN.PTMR.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_practice_eligible |
| Primary pupil-teacher ratio (`SE.PRM.ENRL.TC.ZS`) | held | expert_only | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Refugees hosted (`SM.POP.REFG`) | held | needs_review | 0 | 0 | 0 | 0 | 2 | 0.4 | hold_for_data |
| Remittances received (`BX.TRF.PWKR.DT.GD.ZS`) | passed | expert_only | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_expert_only |
| Renewable electricity (`EG.ELC.RNEW.ZS`) | passed | daily_eligible | 4 | 3 | 4 | 5 | 3 | 3.9 | keep_daily_eligible |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | passed | expert_only | 4 | 3 | 4 | 4 | 3 | 3.65 | keep_expert_only |
| Research and development spending (`GB.XPD.RSDV.GD.ZS`) | held | expert_only | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | passed | needs_review | 3 | 3 | 4 | 3 | 3 | 3.2 | keep_needs_review |
| Paved roads (`IS.ROD.PAVE.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Rural basic drinking water (`SH.H2O.BASW.RU.ZS`) | passed | practice_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Rural basic sanitation (`SH.STA.BASS.RU.ZS`) | passed | daily_eligible | 3 | 5 | 4 | 4 | 2 | 3.55 | review_ambiguity |
| Rural clean cooking access (`EG.CFT.ACCS.RU.ZS`) | passed | retired | 4 | 4 | 4 | 4 | 2 | 3.6 | keep_retired |
| Rural density on arable land (`EN.RUR.DNST`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Rural electricity access (`EG.ELC.ACCS.RU.ZS`) | passed | needs_review | 4 | 4 | 4 | 3 | 2 | 3.35 | keep_needs_review |
| Rural low-elevation land (`AG.LND.EL5M.RU.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 2 | 3.15 | review_ambiguity |
| Rural low-elevation population (`EN.POP.EL5M.RU.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 3 | 3.35 | keep_expert_only |
| Rural open defecation (`SH.STA.ODFC.RU.ZS`) | passed | expert_only | 3 | 5 | 4 | 4 | 2 | 3.55 | review_ambiguity |
| Rural population (`SP.RUR.TOTL.ZS`) | passed | retired | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_retired |
| Rural population growth (`SP.RUR.TOTL.ZG`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_daily_eligible |
| Basic drinking water access (`SH.H2O.BASW.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Safely managed drinking water (`SH.H2O.SMDW.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_practice_eligible |
| Safely managed sanitation (`SH.STA.SMSS.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_practice_eligible |
| Science and engineering students (`SE.TER.SCIE.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Secondary education spending share (`SE.XPD.SECO.ZS`) | held | needs_review | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Secondary enrollment (`SE.SEC.ENRR`) | passed | daily_eligible | 3 | 4 | 4 | 4 | 5 | 4.0 | keep_daily_eligible |
| Female secondary teachers (`SE.SEC.TCHR.FE.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Secondary enrollment gender parity (`SE.ENR.SECO.FM.ZS`) | held | needs_review | 1 | 4 | 2 | 1 | 2 | 1.85 | hold_for_data |
| Private secondary enrollment (`SE.SEC.PRIV.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Secondary pupil-teacher ratio (`SE.SEC.ENRL.TC.ZS`) | held | needs_review | 1 | 2 | 2 | 1 | 2 | 1.55 | hold_for_data |
| Female secondary pupils (`SE.SEC.ENRL.FE.ZS`) | passed | practice_eligible | 3 | 1 | 4 | 3 | 3 | 2.9 | review_for_demotion |
| Secondary repeaters (`SE.SEC.REPT.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Vocational secondary enrollment (`SE.SEC.ENRL.VO.ZS`) | held | needs_review | 1 | 3 | 2 | 1 | 2 | 1.7 | hold_for_data |
| Secure internet servers (`IT.NET.SECR.P6`) | passed | expert_only | 4 | 5 | 5 | 4 | 3 | 4.15 | keep_expert_only |
| Self-employed workers (`SL.EMP.SELF.ZS`) | passed | needs_review | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_needs_review |
| Services value added (`NV.SRV.TOTL.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 4 | 2 | 3.55 | review_ambiguity |
| Severe food insecurity (`SN.ITK.SVFI.ZS`) | passed | expert_only | 3 | 4 | 4 | 4 | 3 | 3.6 | keep_expert_only |
...
| Tourism receipts (`ST.INT.RCPT.XP.ZS`) | passed | expert_only | 3 | 2 | 4 | 4 | 3 | 3.3 | keep_expert_only |
| Tractors per arable land (`AG.LND.TRAC.ZS`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
...
| Unemployment with advanced education (`SL.UEM.ADVN.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Upper-secondary attainment (`SE.SEC.CUAT.UP.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Large urban agglomerations (`EN.URB.MCTY.TL.ZS`) | held | needs_review | 2 | 5 | 2 | 2 | 2 | 2.45 | hold_for_data |
| Urban basic drinking water (`SH.H2O.BASW.UR.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_daily_eligible |
| Urban basic sanitation (`SH.STA.BASS.UR.ZS`) | passed | practice_eligible | 3 | 5 | 4 | 3 | 2 | 3.3 | review_ambiguity |
| Urban clean cooking access (`EG.CFT.ACCS.UR.ZS`) | passed | practice_eligible | 4 | 4 | 4 | 4 | 2 | 3.6 | review_ambiguity |
| Urban electricity access (`EG.ELC.ACCS.UR.ZS`) | passed | practice_eligible | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_practice_eligible |
| Urban low-elevation land (`AG.LND.EL5M.UR.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 3 | 3.35 | keep_expert_only |
| Urban low-elevation population (`EN.POP.EL5M.UR.ZS`) | passed | expert_only | 4 | 1 | 4 | 4 | 2 | 3.15 | review_ambiguity |
| Urban open defecation (`SH.STA.ODFC.UR.ZS`) | passed | expert_only | 3 | 5 | 4 | 4 | 3 | 3.75 | keep_expert_only |
| Urban population (`SP.URB.TOTL.IN.ZS`) | passed | daily_eligible | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Urban population growth (`SP.URB.GROW`) | passed | practice_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_practice_eligible |
| Urban slum population (`EN.POP.SLUM.UR.ZS`) | passed | practice_eligible | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_practice_eligible |
| Vulnerable employment (`SL.EMP.VULN.ZS`) | passed | retired | 4 | 5 | 4 | 4 | 2 | 3.75 | keep_retired |
| Wage and salaried workers (`SL.EMP.WORK.ZS`) | passed | expert_only | 4 | 5 | 4 | 4 | 2 | 3.75 | review_ambiguity |
| Water productivity (`ER.GDP.FWTL.M3.KD`) | passed | expert_only | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_expert_only |
| Water stress (`ER.H2O.FWST.ZS`) | passed | expert_only | 4 | 4 | 4 | 4 | 3 | 3.8 | keep_expert_only |
| Control of corruption rank (`CC.PER.RNK`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Government effectiveness rank (`GE.PER.RNK`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Political stability rank (`PV.PER.RNK`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Regulatory quality rank (`RQ.PER.RNK`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
| Rule of law rank (`RL.PER.RNK`) | held | needs_review | 0 | 0 | 2 | 0 | 2 | 0.8 | hold_for_data |
...
| Youth not in education or work (`SL.UEM.NEET.ZS`) | held | needs_review | 1 | 5 | 2 | 1 | 2 | 2.0 | hold_for_data |
| Youth unemployment (`SL.UEM.1524.ZS`) | passed | practice_eligible | 4 | 5 | 4 | 4 | 3 | 3.95 | keep_practice_eligible |
...
- `lower-secondary-completion` (`SE.SEC.CMPT.LO.ZS`): lower-secondary-completion: no year in 2015:2025 met 120 mapped countries; best coverage was 114 lower-secondary-completion: selected coverage 10 is below 120
...
- `modern-contraceptive-use` (`SP.DYN.CONM.ZS`): modern-contraceptive-use: no year in 2015:2025 met 120 mapped countries; best coverage was 38 modern-contraceptive-use: selected coverage 1 is below 120
...
- `primary-completion` (`SE.PRM.CMPT.ZS`): primary-completion: no year in 2015:2025 met 120 mapped countries; best coverage was 118 primary-completion: selected coverage 9 is below 120
...
- `roads-paved` (`IS.ROD.PAVE.ZS`): roads-paved: no year in 2015:2025 met 120 mapped countries; best coverage was 0 roads-paved: selected coverage 0 is below 120
...
- `secondary-private-enrollment` (`SE.SEC.PRIV.ZS`): secondary-private-enrollment: no year in 2015:2025 met 120 mapped countries; best coverage was 119 secondary-private-enrollment: selected coverage 1 is below 120
...
- `skilled-birth-attendance` (`SH.STA.BRTC.ZS`): skilled-birth-attendance: no year in 2015:2025 met 120 mapped countries; best coverage was 90 skilled-birth-attendance: selected coverage 3 is below 120
...
- `urban-agglomerations-share` (`EN.URB.MCTY.TL.ZS`): urban-agglomerations-share: no year in 2015:2025 met 120 mapped countries; best coverage was 119 urban-agglomerations-share: selected coverage 119 is below 120
- `wgi-control-corruption-rank` (`CC.PER.RNK`): Unexpected World Bank response for https://api.worldbank.org/v2/country/all/indicator/CC.PER.RNK?format=json&per_page=20000&page=1&date=2015%3A2025
- `wgi-government-effectiveness-rank` (`GE.PER.RNK`): Unexpected World Bank response for https://api.worldbank.org/v2/country/all/indicator/GE.PER.RNK?format=json&per_page=20000&page=1&date=2015%3A2025
