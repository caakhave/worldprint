...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.86 | 0.83 | 169 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Safely managed drinking water (`SH.H2O.SMDW.ZS`) | -0.84 | -0.86 | 122 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.81 | 0.85 | 166 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.81 | 0.85 | 166 | 0.36 | ok | Reasonable distractor candidate; no major automated warning. |
| Maternal mortality (`SH.STA.MMRT`) | 0.72 | 0.85 | 167 | 0.36 | ok | Reasonable distractor candidate; no major automated warning. |
| Communicable disease deaths (`SH.DTH.COMM.ZS`) | 0.84 | 0.82 | 167 | 0.39 | ok | Reasonable distractor candidate; no major automated warning. |

## Female adult mortality (`SP.DYN.AMRT.FE`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.96 | -0.98 | 149 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Male adult mortality (`SP.DYN.AMRT.MA`) | 0.92 | 0.92 | 149 | 0.55 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Maternal mortality (`SH.STA.MMRT`) | 0.85 | 0.91 | 147 | 0.44 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.89 | 0.91 | 146 | 0.43 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.86 | 0.91 | 146 | 0.45 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Neonatal mortality (`SH.DYN.NMRT`) | 0.86 | 0.88 | 146 | 0.43 | review | Same or closely related topic; use only when the tier calls for close distractors. |

## Male adult mortality (`SP.DYN.AMRT.MA`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Female adult mortality (`SP.DYN.AMRT.FE`) | 0.92 | 0.92 | 149 | 0.55 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.91 | -0.92 | 149 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.74 | 0.79 | 146 | 0.36 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Basic sanitation access (`SH.STA.BASS.ZS`) | -0.72 | -0.79 | 136 | 0.10 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.77 | 0.79 | 146 | 0.38 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Maternal mortality (`SH.STA.MMRT`) | 0.70 | 0.79 | 147 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Fertility rate (`SP.DYN.TFRT.IN`) | 0.86 | 0.69 | 169 | 0.37 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GDP growth (`NY.GDP.MKTP.KD.ZG`) | 0.27 | 0.35 | 149 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Food production index (`AG.PRD.FOOD.XD`) | 0.17 | 0.33 | 149 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Tax revenue (`GC.TAX.TOTL.GD.ZS`) | -0.13 | -0.33 | 113 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita (`NY.GNP.PCAP.CD`) | -0.56 | -0.90 | 148 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita (`NY.GDP.PCAP.CD`) | -0.54 | -0.90 | 148 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | -0.49 | -0.88 | 146 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Employment in agriculture (`SL.AGR.EMPL.ZS`) | 0.83 | 0.88 | 147 | 0.49 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | -0.66 | -0.87 | 148 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | -0.65 | -0.87 | 148 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |

## Agriculture value per worker (`NV.AGR.EMPL.KD`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Rural electricity access (`EG.ELC.ACCS.RU.ZS`) | 0.44 | 0.65 | 135 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
| Electricity access (`EG.ELC.ACCS.ZS`) | 0.43 | 0.65 | 138 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.13 | 0.65 | 138 | 0.32 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.46 | -0.64 | 138 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.44 | 0.64 | 138 | 0.33 | ok | Reasonable distractor candidate; no major automated warning. |
| Nurses and midwives (`SH.MED.NUMW.P3`) | 0.46 | 0.64 | 126 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |

## Basic sanitation access (`SH.STA.BASS.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population ages 0-14 (`SP.POP.0014.TO.ZS`) | 0.98 | 0.99 | 169 | 0.78 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Fertility rate (`SP.DYN.TFRT.IN`) | 0.98 | 0.97 | 169 | 0.72 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.87 | 0.91 | 166 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.81 | -0.90 | 169 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.87 | 0.90 | 166 | 0.46 | high | Very high correlation can make the pair unfairly ambiguous. |
| Neonatal mortality (`SH.DYN.NMRT`) | 0.86 | 0.88 | 166 | 0.43 | ok | Reasonable distractor candidate; no major automated warning. |

## Carbon intensity of GDP (`EN.GHG.CO2.RT.GDP.KD`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Fossil electricity share (`EG.ELC.FOSL.ZS`) | 0.40 | 0.52 | 133 | 0.31 | ok | Reasonable distractor candidate; no major automated warning. |
| Non-hydro renewable electricity (`EG.ELC.RNWX.ZS`) | -0.37 | -0.46 | 156 | 0.12 | ok | Reasonable distractor candidate; no major automated warning. |
| Industry value added (`NV.IND.TOTL.ZS`) | 0.39 | 0.45 | 147 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Water productivity (`ER.GDP.FWTL.M3.KD`) | -0.17 | -0.42 | 152 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Birth rate (`SP.DYN.CBRT.IN`) | -0.45 | -0.69 | 167 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.98 | 0.99 | 169 | 0.78 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Fertility rate (`SP.DYN.TFRT.IN`) | 0.95 | 0.96 | 169 | 0.69 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.84 | 0.91 | 166 | 0.45 | high | Very high correlation can make the pair unfairly ambiguous. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.85 | -0.90 | 169 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.86 | 0.90 | 166 | 0.43 | ok | Reasonable distractor candidate; no major automated warning. |
| Neonatal mortality (`SH.DYN.NMRT`) | 0.85 | 0.88 | 166 | 0.39 | ok | Reasonable distractor candidate; no major automated warning. |

## Clean cooking fuels access (`EG.CFT.ACCS.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | 0.96 | 0.95 | 165 | 0.65 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Energy use (`EG.USE.PCAP.KG.OE`) | 0.88 | 0.95 | 139 | 0.51 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.59 | 0.92 | 138 | 0.51 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.67 | 0.89 | 154 | 0.54 | review | Same or closely related topic; use only when the tier calls for close distractors. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.64 | 0.88 | 154 | 0.49 | review | Same or closely related topic; use only when the tier calls for close distractors. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Internet users (`IT.NET.USER.ZS`) | 0.53 | 0.87 | 152 | 0.42 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |

## Coal electricity share (`EG.ELC.COAL.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Noncommunicable disease deaths (`SH.DTH.NCOM.ZS`) | -0.97 | -0.97 | 167 | 0.10 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Adolescent fertility (`SP.ADO.TFRT`) | 0.84 | 0.82 | 167 | 0.39 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.84 | 0.81 | 166 | 0.40 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.84 | -0.80 | 167 | 0.11 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Domestic savings (`NY.GDS.TOTL.ZS`) | 0.61 | 0.48 | 122 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Gross savings (`NY.GNS.ICTR.ZS`) | 0.60 | 0.47 | 122 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.46 | 0.38 | 138 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |
| Industry value added (`NV.IND.TOTL.ZS`) | 0.46 | 0.32 | 131 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.45 | 0.37 | 138 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |
| Household consumption (`NE.CON.PRVT.ZS`) | -0.44 | -0.41 | 125 | 0.10 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.67 | 0.54 | 169 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Hospital beds (`SH.MED.BEDS.ZS`) | 0.57 | 0.53 | 120 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Industrial water withdrawals (`ER.H2O.FWIN.ZS`) | 0.55 | 0.51 | 160 | 0.22 | ok | Reasonable distractor candidate; no major automated warning. |
| Population growth (`SP.POP.GROW`) | -0.54 | -0.52 | 169 | 0.11 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Women, Business and the Law index (`GD_WBL_OVL_LAW`) | 0.49 | 0.48 | 164 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.48 | 0.47 | 120 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |

## Private-sector bank credit (`FD.AST.PRVT.GD.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Household consumption (`NE.CON.PRVT.ZS`) | -0.85 | -0.89 | 134 | 0.04 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Gross savings (`NY.GNS.ICTR.ZS`) | 0.80 | 0.76 | 122 | 0.46 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Current account balance (`BN.CAB.XOKA.GD.ZS`) | 0.61 | 0.48 | 122 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Remittances received (`BX.TRF.PWKR.DT.GD.ZS`) | -0.56 | -0.61 | 119 | 0.06 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | 0.42 | 0.49 | 136 | 0.25 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | 0.41 | 0.48 | 136 | 0.24 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |

## Domestic water withdrawals (`ER.H2O.FWDM.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Energy use (`EG.USE.PCAP.KG.OE`) | 0.86 | 0.95 | 141 | 0.62 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.72 | 0.94 | 133 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.68 | 0.94 | 133 | 0.47 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.74 | 0.93 | 134 | 0.46 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.68 | 0.93 | 134 | 0.45 | high | Very high correlation can make the pair unfairly ambiguous. |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | 0.59 | 0.92 | 138 | 0.51 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.24 | 0.22 | 118 | 0.21 | ok | Reasonable distractor candidate; no major automated warning. |
| Fixed telephone subscriptions (`IT.MLT.MAIN.P2`) | 0.06 | 0.24 | 129 | 0.22 | ok | Reasonable distractor candidate; no major automated warning. |
| Domestic savings (`NY.GDS.TOTL.ZS`) | -0.24 | -0.07 | 136 | 0.15 | ok | Reasonable distractor candidate; no major automated warning. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.23 | 0.23 | 117 | 0.21 | ok | Reasonable distractor candidate; no major automated warning. |
| Youth unemployment (`SL.UEM.1524.ZS`) | 0.23 | 0.21 | 163 | 0.21 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Unemployment (`SL.UEM.TOTL.ZS`) | 0.18 | 0.23 | 163 | 0.20 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.86 | 0.95 | 141 | 0.62 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | 0.88 | 0.95 | 139 | 0.51 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | 0.84 | 0.93 | 139 | 0.54 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.72 | 0.90 | 134 | 0.49 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.68 | 0.90 | 134 | 0.46 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.65 | 0.89 | 135 | 0.44 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Trade (`NE.TRD.GNFS.ZS`) | 0.96 | 0.94 | 141 | 0.58 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Imports (`NE.IMP.GNFS.ZS`) | 0.84 | 0.81 | 141 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Foreign direct investment outflows (`BM.KLT.DINV.WD.GD.ZS`) | 0.95 | 0.19 | 140 | 0.21 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Water productivity (`ER.GDP.FWTL.M3.KD`) | 0.39 | -0.05 | 150 | 0.14 | ok | Reasonable distractor candidate; no major automated warning. |
| Hydroelectricity share (`EG.ELC.HYRO.ZS`) | 0.15 | 0.33 | 119 | 0.18 | ok | Reasonable distractor candidate; no major automated warning. |
| Current account balance (`BN.CAB.XOKA.GD.ZS`) | 0.01 | -0.32 | 138 | 0.07 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Imports (`NE.IMP.GNFS.ZS`) | 0.14 | 0.29 | 137 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Water stress (`ER.H2O.FWST.ZS`) | -0.01 | -0.29 | 149 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |

## Foreign direct investment outflows (`BM.KLT.DINV.WD.GD.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Foreign direct investment inflows (`BX.KLT.DINV.WD.GD.ZS`) | 0.95 | 0.19 | 140 | 0.21 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Water productivity (`ER.GDP.FWTL.M3.KD`) | 0.45 | 0.30 | 135 | 0.21 | ok | Reasonable distractor candidate; no major automated warning. |
| Logistics infrastructure quality (`LP.LPI.INFR.XQ`) | 0.11 | 0.45 | 119 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.11 | 0.45 | 123 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Unemployment (`SL.UEM.TOTL.ZS`) | 0.94 | 0.94 | 163 | 0.69 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.98 | 0.97 | 169 | 0.72 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 0-14 (`SP.POP.0014.TO.ZS`) | 0.95 | 0.96 | 169 | 0.69 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.87 | 0.87 | 166 | 0.43 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.85 | 0.86 | 166 | 0.41 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.70 | 0.91 | 131 | 0.44 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.79 | 0.89 | 131 | 0.50 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.77 | 0.89 | 131 | 0.47 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.73 | 0.89 | 132 | 0.50 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.71 | 0.89 | 132 | 0.50 | ok | Reasonable distractor candidate; no major automated warning. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.72 | -0.89 | 133 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |

## Fixed capital formation (`NE.GDI.FTOT.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Gross capital formation (`NE.GDI.TOTL.ZS`) | 0.85 | 0.87 | 138 | 0.57 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Fixed broadband (`IT.NET.BBND.P2`) | 0.74 | 0.81 | 126 | 0.36 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.58 | 0.78 | 125 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.49 | 0.77 | 126 | 0.32 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Crop production index (`AG.PRD.CROP.XD`) | 0.87 | 0.84 | 168 | 0.49 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Livestock production index (`AG.PRD.LVSK.XD`) | 0.68 | 0.67 | 168 | 0.38 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.45 | -0.54 | 168 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Services value added (`NV.SRV.TOTL.ZS`) | -0.39 | -0.48 | 149 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | -0.38 | -0.48 | 120 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| Population growth (`SP.POP.GROW`) | 0.48 | 0.46 | 168 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Freshwater per person (`ER.H2O.INTR.PC`) | 0.25 | 0.69 | 164 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Average precipitation (`AG.LND.PRCP.MM`) | 0.67 | 0.69 | 163 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | -0.21 | -0.58 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Water stress (`ER.H2O.FWST.ZS`) | -0.23 | -0.52 | 161 | 0.07 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Agricultural land (`AG.LND.AGRI.ZS`) | -0.52 | -0.47 | 169 | 0.14 | ok | Reasonable distractor candidate; no major automated warning. |
| Fossil electricity share (`EG.ELC.FOSL.ZS`) | -0.32 | -0.37 | 141 | 0.14 | ok | Reasonable distractor candidate; no major automated warning. |
...
- Category: economy
- Difficulty: expert
- Coverage: 159 countries
- Warning level: review

| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Net forest depletion (`NY.ADJ.DFOR.GN.ZS`) | 0.77 | 0.44 | 152 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Rural electricity access (`EG.ELC.ACCS.RU.ZS`) | -0.66 | -0.75 | 156 | 0.15 | ok | Reasonable distractor candidate; no major automated warning. |
| Electricity access (`EG.ELC.ACCS.ZS`) | -0.69 | -0.75 | 159 | 0.16 | ok | Reasonable distractor candidate; no major automated warning. |
| Female adult mortality (`SP.DYN.AMRT.FE`) | 0.54 | 0.75 | 139 | 0.28 | ok | Reasonable distractor candidate; no major automated warning. |
| Basic sanitation access (`SH.STA.BASS.ZS`) | -0.69 | -0.74 | 149 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.56 | -0.74 | 159 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Renewable electricity (`EG.ELC.RNEW.ZS`) | -0.89 | -0.90 | 138 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Hydroelectricity share (`EG.ELC.HYRO.ZS`) | -0.72 | -0.72 | 123 | 0.12 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Natural gas electricity share (`EG.ELC.NGAS.ZS`) | 0.61 | 0.55 | 141 | 0.21 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Carbon intensity of GDP (`EN.GHG.CO2.RT.GDP.KD`) | 0.40 | 0.52 | 133 | 0.31 | ok | Reasonable distractor candidate; no major automated warning. |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | -0.42 | -0.51 | 141 | 0.10 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater per person (`ER.H2O.INTR.PC`) | -0.24 | -0.49 | 139 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Adolescent fertility (`SP.ADO.TFRT`) | n/a | n/a | 142 | 0.18 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | -0.06 | -0.78 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Forest area (`AG.LND.FRST.ZS`) | 0.25 | 0.69 | 164 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Water stress (`ER.H2O.FWST.ZS`) | 0.30 | 0.91 | 160 | 0.56 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater per person (`ER.H2O.INTR.PC`) | -0.06 | -0.78 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Average precipitation (`AG.LND.PRCP.MM`) | -0.22 | -0.64 | 159 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Forest area (`AG.LND.FRST.ZS`) | -0.21 | -0.58 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Hydroelectricity share (`EG.ELC.HYRO.ZS`) | -0.10 | -0.57 | 122 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | -0.16 | -0.49 | 160 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GDP per person growth (`NY.GDP.PCAP.KD.ZG`) | 0.97 | 0.85 | 160 | 0.41 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Government consumption (`NE.CON.GOVT.ZS`) | -0.39 | -0.56 | 141 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | -0.34 | -0.56 | 118 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Safely managed sanitation (`SH.STA.SMSS.ZS`) | -0.27 | -0.53 | 118 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | 0.09 | 0.51 | 147 | 0.20 | ok | Reasonable distractor candidate; no major automated warning. |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | -0.44 | -0.51 | 118 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.98 | 1.00 | 159 | 0.89 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.95 | 0.98 | 157 | 0.72 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.93 | 0.98 | 157 | 0.73 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.91 | 0.97 | 156 | 0.64 | high | Very high correlation can make the pair unfairly ambiguous. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.44 | -0.94 | 147 | 0.05 | high | Very high correlation can make the pair unfairly ambiguous. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.68 | 0.93 | 134 | 0.45 | high | Very high correlation can make the pair unfairly ambiguous. |

## GDP per person growth (`NY.GDP.PCAP.KD.ZG`)
...
- Category: development
- Difficulty: standard
- Coverage: 157 countries
- Warning level: high

| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.99 | 1.00 | 157 | 0.90 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.95 | 0.98 | 157 | 0.72 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.93 | 0.98 | 157 | 0.73 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.80 | 0.94 | 155 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.68 | 0.94 | 133 | 0.47 | high | Very high correlation can make the pair unfairly ambiguous. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.53 | -0.92 | 147 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. |

## Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | 0.96 | 0.95 | 165 | 0.65 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Energy use (`EG.USE.PCAP.KG.OE`) | 0.84 | 0.93 | 139 | 0.54 | high | Very high correlation can make the pair unfairly ambiguous. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.56 | 0.88 | 138 | 0.50 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.63 | 0.84 | 154 | 0.45 | review | Same or closely related topic; use only when the tier calls for close distractors. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.60 | 0.84 | 154 | 0.41 | review | Same or closely related topic; use only when the tier calls for close distractors. Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Internet users (`IT.NET.USER.ZS`) | 0.52 | 0.82 | 152 | 0.41 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.98 | 1.00 | 159 | 0.89 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.94 | 0.98 | 157 | 0.76 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.93 | 0.98 | 157 | 0.73 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.93 | 0.97 | 156 | 0.66 | high | Very high correlation can make the pair unfairly ambiguous. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.45 | -0.94 | 147 | 0.07 | high | Very high correlation can make the pair unfairly ambiguous. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.74 | 0.93 | 134 | 0.46 | high | Very high correlation can make the pair unfairly ambiguous. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.99 | 1.00 | 157 | 0.90 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.94 | 0.98 | 157 | 0.76 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.93 | 0.98 | 157 | 0.73 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.72 | 0.94 | 133 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.82 | 0.94 | 155 | 0.55 | high | Very high correlation can make the pair unfairly ambiguous. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.55 | -0.93 | 147 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. |

## Government consumption (`NE.CON.GOVT.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Education spending (`SE.XPD.TOTL.GD.ZS`) | 0.69 | 0.67 | 118 | 0.33 | ok | Reasonable distractor candidate; no major automated warning. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.60 | 0.67 | 110 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.56 | 0.65 | 111 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Safely managed drinking water (`SH.H2O.SMDW.ZS`) | 0.48 | 0.61 | 107 | 0.39 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.95 | 0.95 | 118 | 0.53 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Tax revenue (`GC.TAX.TOTL.GD.ZS`) | 0.73 | 0.75 | 118 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.69 | 0.72 | 120 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.39 | 0.71 | 120 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Government health spending share (`SH.XPD.GHED.CH.ZS`) | 0.70 | 0.71 | 119 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Urban slum population (`EN.POP.SLUM.UR.ZS`) | -0.65 | -0.70 | 106 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |

## Government health spending share (`SH.XPD.GHED.CH.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.58 | 0.79 | 156 | 0.34 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.56 | 0.78 | 156 | 0.33 | ok | Reasonable distractor candidate; no major automated warning. |
| Private health spending share (`SH.XPD.PVTD.CH.ZS`) | -0.77 | -0.78 | 164 | 0.05 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.69 | 0.77 | 155 | 0.37 | ok | Reasonable distractor candidate; no major automated warning. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.53 | 0.77 | 139 | 0.37 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.46 | 0.77 | 163 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Domestic savings (`NY.GDS.TOTL.ZS`) | 0.80 | 0.76 | 122 | 0.46 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Gross capital formation (`NE.GDI.TOTL.ZS`) | 0.56 | 0.66 | 122 | 0.36 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Household consumption (`NE.CON.PRVT.ZS`) | -0.60 | -0.64 | 118 | 0.11 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Current account balance (`BN.CAB.XOKA.GD.ZS`) | 0.60 | 0.47 | 122 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Fixed capital formation (`NE.GDI.FTOT.ZS`) | 0.51 | 0.59 | 121 | 0.36 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Industry value added (`NV.IND.TOTL.ZS`) | 0.51 | 0.45 | 117 | 0.20 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.56 | 0.59 | 163 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.55 | 0.57 | 119 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Fixed broadband (`IT.NET.BBND.P2`) | 0.57 | 0.56 | 132 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Government consumption (`NE.CON.GOVT.ZS`) | 0.51 | 0.57 | 142 | 0.21 | ok | Reasonable distractor candidate; no major automated warning. |
| Tertiary enrollment (`SE.TER.ENRR`) | 0.56 | 0.57 | 123 | 0.24 | ok | Reasonable distractor candidate; no major automated warning. |
| Safely managed drinking water (`SH.H2O.SMDW.ZS`) | 0.46 | 0.55 | 119 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |

## Health spending per person (`SH.XPD.CHEX.PC.CD`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.93 | 0.97 | 156 | 0.66 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.91 | 0.97 | 156 | 0.64 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.82 | 0.94 | 155 | 0.55 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.80 | 0.94 | 155 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.39 | -0.94 | 147 | 0.06 | high | Very high correlation can make the pair unfairly ambiguous. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.61 | 0.91 | 138 | 0.39 | high | Very high correlation can make the pair unfairly ambiguous. |

## Hepatitis B immunization (`SH.IMM.HEPB`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Domestic savings (`NY.GDS.TOTL.ZS`) | -0.85 | -0.89 | 134 | 0.04 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | -0.57 | -0.72 | 141 | 0.09 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Energy use (`EG.USE.PCAP.KG.OE`) | -0.53 | -0.71 | 122 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Remittances received (`BX.TRF.PWKR.DT.GD.ZS`) | 0.61 | 0.70 | 122 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | -0.57 | -0.69 | 141 | 0.08 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | -0.62 | -0.65 | 138 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |

## Hydroelectricity share (`EG.ELC.HYRO.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Renewable electricity (`EG.ELC.RNEW.ZS`) | 0.81 | 0.80 | 120 | 0.41 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Fossil electricity share (`EG.ELC.FOSL.ZS`) | -0.72 | -0.72 | 123 | 0.12 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | 0.59 | 0.65 | 124 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | -0.10 | -0.57 | 122 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Agricultural water withdrawals (`ER.H2O.FWAG.ZS`) | -0.76 | -0.78 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.62 | 0.50 | 160 | 0.28 | ok | Reasonable distractor candidate; no major automated warning. |
| Hospital beds (`SH.MED.BEDS.ZS`) | 0.49 | 0.61 | 116 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |
| Tertiary enrollment (`SE.TER.ENRR`) | 0.54 | 0.60 | 122 | 0.24 | ok | Reasonable distractor candidate; no major automated warning. |
| Physicians (`SH.MED.PHYS.ZS`) | 0.50 | 0.57 | 120 | 0.23 | ok | Reasonable distractor candidate; no major automated warning. |
| Death rate (`SP.DYN.CDRT.IN`) | 0.55 | 0.51 | 160 | 0.22 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Natural resource rents (`NY.GDP.TOTL.RT.ZS`) | 0.63 | 0.47 | 146 | 0.23 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Services value added (`NV.SRV.TOTL.ZS`) | -0.57 | -0.51 | 149 | 0.11 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Gross savings (`NY.GNS.ICTR.ZS`) | 0.51 | 0.45 | 117 | 0.20 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | 0.50 | 0.31 | 147 | 0.19 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Natural resource depletion (`NY.ADJ.DRES.GN.ZS`) | 0.43 | 0.50 | 141 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |
| Current account balance (`BN.CAB.XOKA.GD.ZS`) | 0.46 | 0.32 | 131 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Under-5 mortality (`SH.DYN.MORT`) | 0.98 | 1.00 | 166 | 0.92 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| Neonatal mortality (`SH.DYN.NMRT`) | 0.98 | 0.99 | 166 | 0.79 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.92 | -0.92 | 166 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Maternal mortality (`SH.STA.MMRT`) | 0.87 | 0.92 | 166 | 0.49 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Female adult mortality (`SP.DYN.AMRT.FE`) | 0.89 | 0.91 | 146 | 0.43 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.87 | 0.90 | 166 | 0.46 | high | Very high correlation can make the pair unfairly ambiguous. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Clean cooking fuels access (`EG.CFT.ACCS.ZS`) | 0.91 | 0.86 | 151 | 0.40 | high | Very high correlation can make the pair unfairly ambiguous. |
| Basic sanitation access (`SH.STA.BASS.ZS`) | 0.91 | 0.85 | 144 | 0.44 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.71 | 0.90 | 149 | 0.56 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.59 | 0.90 | 150 | 0.52 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.69 | 0.90 | 149 | 0.51 | ok | Reasonable distractor candidate; no major automated warning. |
| Basic drinking water access (`SH.H2O.BASW.ZS`) | 0.89 | 0.86 | 149 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |

## Female-to-male labor force ratio (`SL.TLF.CACT.FM.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Female adult mortality (`SP.DYN.AMRT.FE`) | -0.96 | -0.98 | 149 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.90 | -0.93 | 166 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.92 | -0.92 | 166 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Male adult mortality (`SP.DYN.AMRT.MA`) | -0.91 | -0.92 | 149 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.74 | -0.91 | 149 | 0.06 | high | Very high correlation can make the pair unfairly ambiguous. |
| Neonatal mortality (`SH.DYN.NMRT`) | -0.90 | -0.90 | 166 | 0.10 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Food production index (`AG.PRD.FOOD.XD`) | 0.68 | 0.67 | 168 | 0.38 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Death rate (`SP.DYN.CDRT.IN`) | -0.40 | -0.40 | 168 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Crop production index (`AG.PRD.CROP.XD`) | 0.39 | 0.35 | 168 | 0.19 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Services value added (`NV.SRV.TOTL.ZS`) | -0.35 | -0.37 | 149 | 0.12 | ok | Reasonable distractor candidate; no major automated warning. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.36 | -0.36 | 168 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| Government consumption (`NE.CON.GOVT.ZS`) | -0.29 | -0.36 | 144 | 0.11 | ok | Reasonable distractor candidate; no major automated warning. |

## Logistics infrastructure quality (`LP.LPI.INFR.XQ`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.87 | 0.92 | 166 | 0.49 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.89 | 0.91 | 166 | 0.52 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| CO2 emissions per capita (`EN.GHG.CO2.PC.CE.AR5`) | 0.73 | 0.60 | 165 | 0.27 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Net migration (`SM.POP.NETM`) | 0.54 | -0.00 | 140 | 0.15 | ok | Reasonable distractor candidate; no major automated warning. |
| Government consumption (`NE.CON.GOVT.ZS`) | 0.43 | 0.45 | 126 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Average precipitation (`AG.LND.PRCP.MM`) | -0.22 | -0.43 | 137 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.16 | 0.37 | 108 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.15 | 0.36 | 109 | 0.24 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Female adult mortality (`SP.DYN.AMRT.FE`) | -0.18 | -0.35 | 121 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Fossil electricity share (`EG.ELC.FOSL.ZS`) | 0.61 | 0.55 | 141 | 0.21 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Natural resource rents (`NY.GDP.TOTL.RT.ZS`) | 0.81 | 0.92 | 152 | 0.62 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Services value added (`NV.SRV.TOTL.ZS`) | -0.40 | -0.62 | 141 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Natural resource depletion (`NY.ADJ.DRES.GN.ZS`) | 0.81 | 0.92 | 152 | 0.62 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Services value added (`NV.SRV.TOTL.ZS`) | -0.52 | -0.66 | 146 | 0.10 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.98 | 0.99 | 166 | 0.79 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | 0.94 | 0.99 | 166 | 0.76 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Maternal mortality (`SH.STA.MMRT`) | 0.85 | 0.91 | 166 | 0.42 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.90 | -0.90 | 166 | 0.10 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.86 | 0.88 | 166 | 0.43 | ok | Reasonable distractor candidate; no major automated warning. |
| Female adult mortality (`SP.DYN.AMRT.FE`) | 0.86 | 0.88 | 146 | 0.43 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Communicable disease deaths (`SH.DTH.COMM.ZS`) | -0.97 | -0.97 | 167 | 0.10 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.84 | -0.86 | 166 | 0.10 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.82 | -0.86 | 166 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | 0.85 | 0.83 | 167 | 0.44 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Fixed broadband (`IT.NET.BBND.P2`) | 0.82 | 0.85 | 134 | 0.32 | ok | Reasonable distractor candidate; no major automated warning. |
| Birth rate (`SP.DYN.CBRT.IN`) | -0.85 | -0.83 | 167 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |

## Non-hydro renewable electricity (`EG.ELC.RNWX.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.83 | 0.86 | 151 | 0.41 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.83 | 0.86 | 143 | 0.43 | ok | Reasonable distractor candidate; no major automated warning. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.63 | -0.86 | 152 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.85 | 0.86 | 144 | 0.47 | ok | Reasonable distractor candidate; no major automated warning. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | 0.66 | 0.85 | 129 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.66 | -0.85 | 152 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |

## Oil electricity share (`EG.ELC.PETR.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Birth rate (`SP.DYN.CBRT.IN`) | -0.81 | -0.90 | 169 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 0-14 (`SP.POP.0014.TO.ZS`) | -0.85 | -0.90 | 169 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Fertility rate (`SP.DYN.TFRT.IN`) | -0.74 | -0.86 | 169 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.67 | -0.84 | 166 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Urban population growth (`SP.URB.GROW`) | -0.70 | -0.84 | 169 | 0.05 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.40 | 0.84 | 169 | 0.47 | ok | Reasonable distractor candidate; no major automated warning. |

## Open defecation (`SH.STA.ODFC.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| GNI per capita (`NY.GNP.PCAP.CD`) | -0.45 | -0.94 | 147 | 0.07 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita (`NY.GDP.PCAP.CD`) | -0.44 | -0.94 | 147 | 0.05 | high | Very high correlation can make the pair unfairly ambiguous. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | -0.39 | -0.94 | 147 | 0.06 | high | Very high correlation can make the pair unfairly ambiguous. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | -0.55 | -0.93 | 147 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | -0.53 | -0.92 | 147 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.74 | -0.91 | 149 | 0.06 | high | Very high correlation can make the pair unfairly ambiguous. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population density (`EN.POP.DNST`) | 0.40 | 0.65 | 167 | 0.31 | ok | Reasonable distractor candidate; no major automated warning. |
| Arable land (`AG.LND.ARBL.ZS`) | 0.25 | 0.46 | 167 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
- Category: health
- Difficulty: standard
- Coverage: 121 countries
- Warning level: review

| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.60 | 0.86 | 120 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.71 | -0.85 | 121 | 0.04 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.74 | -0.85 | 121 | 0.04 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Neonatal mortality (`SH.DYN.NMRT`) | -0.75 | -0.84 | 121 | 0.06 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.69 | -0.84 | 109 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.44 | 0.84 | 121 | 0.38 | ok | Reasonable distractor candidate; no major automated warning. |

## PM2.5 exposure (`EN.ATM.PM25.MC.M3`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population above PM2.5 guideline (`EN.ATM.PM25.MC.ZS`) | 0.45 | 0.78 | 168 | 0.29 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | 0.51 | 0.77 | 149 | 0.38 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.62 | -0.72 | 168 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Physicians (`SH.MED.PHYS.ZS`) | -0.59 | -0.70 | 121 | 0.02 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | -0.31 | -0.70 | 168 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Secondary enrollment (`SE.SEC.ENRR`) | -0.61 | -0.69 | 121 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |

## Population above PM2.5 guideline (`EN.ATM.PM25.MC.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| PM2.5 exposure (`EN.ATM.PM25.MC.M3`) | 0.45 | 0.78 | 168 | 0.29 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | 0.30 | 0.72 | 149 | 0.26 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | -0.68 | -0.66 | 163 | 0.11 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita (`NY.GDP.PCAP.CD`) | -0.62 | -0.65 | 158 | 0.13 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | -0.64 | -0.65 | 158 | 0.13 | ok | Reasonable distractor candidate; no major automated warning. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.46 | -0.65 | 168 | 0.12 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Forest area (`AG.LND.FRST.ZS`) | 0.67 | 0.69 | 163 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater per person (`ER.H2O.INTR.PC`) | 0.35 | 0.68 | 163 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | -0.22 | -0.64 | 159 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Water stress (`ER.H2O.FWST.ZS`) | -0.23 | -0.55 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Permanent cropland (`AG.LND.CROP.ZS`) | 0.31 | 0.46 | 162 | 0.20 | ok | Reasonable distractor candidate; no major automated warning. |
| Military spending (`MS.MIL.XPND.GD.ZS`) | -0.22 | -0.43 | 137 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |

## Preprimary enrollment (`SE.PRE.ENRR`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.61 | -0.72 | 114 | 0.11 | ok | Reasonable distractor candidate; no major automated warning. |
| Secondary enrollment (`SE.SEC.ENRR`) | 0.69 | 0.67 | 98 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | 0.69 | 0.65 | 123 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
| Noncommunicable disease deaths (`SH.DTH.NCOM.ZS`) | 0.68 | 0.65 | 123 | 0.23 | ok | Reasonable distractor candidate; no major automated warning. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.67 | -0.68 | 123 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.66 | -0.68 | 123 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Out-of-pocket health spending (`SH.XPD.OOPC.CH.ZS`) | 0.92 | 0.90 | 164 | 0.52 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Government health spending share (`SH.XPD.GHED.CH.ZS`) | -0.77 | -0.78 | 164 | 0.05 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government consumption (`NE.CON.GOVT.ZS`) | -0.57 | -0.60 | 142 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | -0.48 | -0.50 | 119 | 0.05 | ok | Reasonable distractor candidate; no major automated warning. |
| Energy use (`EG.USE.PCAP.KG.OE`) | -0.40 | -0.50 | 140 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | -0.41 | -0.50 | 139 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |

## Protected land (`ER.LND.PTLD.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Protected land and seas (`ER.PTD.TOTL.ZS`) | 0.75 | 0.70 | 132 | 0.25 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Safely managed sanitation (`SH.STA.SMSS.ZS`) | 0.47 | 0.56 | 93 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.28 | 0.55 | 132 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |
| Women, Business and the Law index (`GD_WBL_OVL_LAW`) | 0.44 | 0.54 | 127 | 0.24 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.45 | 0.54 | 126 | 0.21 | ok | Reasonable distractor candidate; no major automated warning. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.32 | -0.54 | 116 | 0.11 | review | Same or closely related topic; use only when the tier calls for close distractors. |

## Remittances received (`BX.TRF.PWKR.DT.GD.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Household consumption (`NE.CON.PRVT.ZS`) | 0.61 | 0.70 | 122 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Energy use (`EG.USE.PCAP.KG.OE`) | -0.30 | -0.61 | 117 | 0.05 | ok | Reasonable distractor candidate; no major automated warning. |
| Domestic savings (`NY.GDS.TOTL.ZS`) | -0.56 | -0.61 | 119 | 0.06 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Greenhouse gas emissions per capita (`EN.GHG.ALL.PC.CE.AR5`) | -0.30 | -0.61 | 132 | 0.08 | review | Per-capita versus non-per-capita wording can create raw-total confusion risk. |
| Electric power use (`EG.USE.ELEC.KH.PC`) | -0.26 | -0.59 | 116 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | -0.36 | -0.59 | 135 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |

## Renewable electricity (`EG.ELC.RNEW.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Fossil electricity share (`EG.ELC.FOSL.ZS`) | -0.89 | -0.90 | 138 | 0.09 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Hydroelectricity share (`EG.ELC.HYRO.ZS`) | 0.81 | 0.80 | 120 | 0.41 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | 0.47 | 0.57 | 165 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Natural gas electricity share (`EG.ELC.NGAS.ZS`) | -0.51 | -0.44 | 165 | 0.07 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | -0.16 | -0.48 | 156 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
| Freshwater per person (`ER.H2O.INTR.PC`) | 0.14 | 0.48 | 160 | 0.24 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.95 | 0.95 | 118 | 0.53 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Tax revenue (`GC.TAX.TOTL.GD.ZS`) | 0.78 | 0.81 | 120 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.65 | 0.66 | 120 | 0.31 | ok | Reasonable distractor candidate; no major automated warning. |
| Government health spending share (`SH.XPD.GHED.CH.ZS`) | 0.64 | 0.65 | 119 | 0.27 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.59 | 0.90 | 119 | 0.39 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.79 | -0.89 | 112 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Rural clean cooking access (`EG.CFT.ACCS.RU.ZS`) | 0.86 | 0.89 | 117 | 0.32 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.75 | 0.89 | 118 | 0.38 | ok | Reasonable distractor candidate; no major automated warning. |
| Clean cooking fuels access (`EG.CFT.ACCS.ZS`) | 0.86 | 0.89 | 117 | 0.32 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.64 | 0.89 | 119 | 0.45 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.73 | -0.84 | 112 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.56 | 0.80 | 118 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |
| Internet users (`IT.NET.USER.ZS`) | 0.79 | 0.71 | 115 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Under-5 mortality (`SH.DYN.MORT`) | -0.30 | -0.88 | 166 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.33 | -0.87 | 166 | 0.09 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.57 | 0.87 | 163 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita, PPP (`NY.GNP.PCAP.PP.CD`) | 0.46 | 0.86 | 157 | 0.49 | ok | Reasonable distractor candidate; no major automated warning. |
| Neonatal mortality (`SH.DYN.NMRT`) | -0.33 | -0.86 | 166 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.26 | -0.86 | 149 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Employment in services (`SL.SRV.EMPL.ZS`) | 0.67 | 0.70 | 147 | 0.33 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.54 | 0.70 | 146 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Undernourishment (`SN.ITK.DEFC.ZS`) | -0.51 | -0.68 | 150 | 0.04 | ok | Reasonable distractor candidate; no major automated warning. |
| Nurses and midwives (`SH.MED.NUMW.P3`) | 0.61 | 0.65 | 151 | 0.23 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.26 | 0.65 | 164 | 0.22 | ok | Reasonable distractor candidate; no major automated warning. |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.49 | 0.65 | 163 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
| Women, Business and the Law index (`GD_WBL_OVL_LAW`) | 0.62 | 0.65 | 163 | 0.22 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.47 | -0.64 | 164 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Government revenue excluding grants (`GC.REV.XGRT.GD.ZS`) | 0.78 | 0.81 | 120 | 0.35 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government expense (`GC.XPN.TOTL.GD.ZS`) | 0.73 | 0.75 | 118 | 0.30 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Government consumption (`NE.CON.GOVT.ZS`) | 0.47 | 0.55 | 111 | 0.29 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Secondary enrollment (`SE.SEC.ENRR`) | 0.50 | 0.51 | 94 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
| Safely managed drinking water (`SH.H2O.SMDW.ZS`) | 0.40 | 0.51 | 92 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
| Urban slum population (`EN.POP.SLUM.UR.ZS`) | -0.42 | -0.51 | 107 | 0.05 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Health spending per person (`SH.XPD.CHEX.PC.CD`) | 0.59 | 0.82 | 122 | 0.40 | ok | Reasonable distractor candidate; no major automated warning. |
| Maternal mortality (`SH.STA.MMRT`) | -0.67 | -0.82 | 126 | 0.08 | ok | Reasonable distractor candidate; no major automated warning. |
| Infant mortality (`SP.DYN.IMRT.IN`) | -0.75 | -0.82 | 125 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Under-5 mortality (`SH.DYN.MORT`) | -0.72 | -0.81 | 125 | 0.10 | ok | Reasonable distractor candidate; no major automated warning. |
| Neonatal mortality (`SH.DYN.NMRT`) | -0.76 | -0.81 | 125 | 0.07 | ok | Reasonable distractor candidate; no major automated warning. |
| Physicians (`SH.MED.PHYS.ZS`) | 0.74 | 0.81 | 98 | 0.42 | ok | Reasonable distractor candidate; no major automated warning. |

## Tertiary enrollment gender parity (`SE.ENR.TERT.FM.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Water stress (`ER.H2O.FWST.ZS`) | 0.38 | 0.06 | 122 | 0.17 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Infant mortality (`SP.DYN.IMRT.IN`) | 0.98 | 1.00 | 166 | 0.92 | high | Very high correlation can make the pair unfairly ambiguous. The quantile classes produce a visually similar map. Same or closely related topic; use only when the tier calls for close distractors. |
| Neonatal mortality (`SH.DYN.NMRT`) | 0.94 | 0.99 | 166 | 0.76 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Life expectancy (`SP.DYN.LE00.IN`) | -0.90 | -0.93 | 166 | 0.08 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Maternal mortality (`SH.STA.MMRT`) | 0.89 | 0.91 | 166 | 0.52 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Female adult mortality (`SP.DYN.AMRT.FE`) | 0.86 | 0.91 | 146 | 0.45 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Birth rate (`SP.DYN.CBRT.IN`) | 0.87 | 0.91 | 166 | 0.50 | high | Very high correlation can make the pair unfairly ambiguous. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population growth (`SP.POP.GROW`) | 0.91 | 0.95 | 169 | 0.59 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | -0.70 | -0.84 | 169 | 0.05 | review | Same or closely related topic; use only when the tier calls for close distractors. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Domestic water withdrawals (`ER.H2O.FWDM.ZS`) | 0.51 | 0.75 | 157 | 0.31 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Agricultural water withdrawals (`ER.H2O.FWAG.ZS`) | -0.40 | -0.74 | 157 | 0.08 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| GDP per capita (`NY.GDP.PCAP.CD`) | 0.66 | 0.54 | 153 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |
| GDP per capita, PPP (`NY.GDP.PCAP.PP.CD`) | 0.61 | 0.51 | 152 | 0.25 | ok | Reasonable distractor candidate; no major automated warning. |
| Exports (`NE.EXP.GNFS.ZS`) | 0.60 | 0.42 | 136 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
| GNI per capita (`NY.GNP.PCAP.CD`) | 0.57 | 0.54 | 153 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |

## Water stress (`ER.H2O.FWST.ZS`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Freshwater withdrawal (`ER.H2O.FWTL.ZS`) | 0.30 | 0.91 | 160 | 0.56 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
| Freshwater per person (`ER.H2O.INTR.PC`) | -0.07 | -0.67 | 161 | 0.07 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Average precipitation (`AG.LND.PRCP.MM`) | -0.23 | -0.55 | 160 | 0.09 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| International migrant stock (`SM.POP.TOTL.ZS`) | 0.55 | 0.02 | 161 | 0.15 | ok | Reasonable distractor candidate; no major automated warning. |
| Forest area (`AG.LND.FRST.ZS`) | -0.23 | -0.52 | 161 | 0.07 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Renewable energy consumption (`EG.FEC.RNEW.ZS`) | -0.21 | -0.50 | 161 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |

## Women, Business and the Law index (`GD_WBL_OVL_LAW`)
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Population ages 65+ (`SP.POP.65UP.TO.ZS`) | 0.70 | 0.75 | 164 | 0.27 | ok | Reasonable distractor candidate; no major automated warning. |
| Secure internet servers (`IT.NET.SECR.P6`) | 0.33 | 0.71 | 164 | 0.23 | ok | Reasonable distractor candidate; no major automated warning. |
| Particulate emission damage (`NY.ADJ.DPEM.GN.ZS`) | -0.49 | -0.71 | 149 | 0.06 | ok | Reasonable distractor candidate; no major automated warning. |
| Fixed broadband (`IT.NET.BBND.P2`) | 0.64 | 0.70 | 133 | 0.29 | ok | Reasonable distractor candidate; no major automated warning. |
| Physicians (`SH.MED.PHYS.ZS`) | 0.63 | 0.70 | 119 | 0.24 | ok | Reasonable distractor candidate; no major automated warning. |
| Secondary enrollment (`SE.SEC.ENRR`) | 0.57 | 0.69 | 119 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Women, Business and the Law index (`GD_WBL_OVL_LAW`) | 0.56 | 0.54 | 153 | 0.23 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Protected seas (`ER.MRN.PTMR.ZS`) | 0.36 | 0.47 | 121 | 0.26 | ok | Reasonable distractor candidate; no major automated warning. |
| Statistical data infrastructure (`IQ.SPI.PIL5`) | 0.40 | 0.39 | 154 | 0.23 | review | Same or closely related topic; use only when the tier calls for close distractors. |
| Education spending (`SE.XPD.TOTL.GD.ZS`) | 0.34 | 0.40 | 125 | 0.30 | ok | Reasonable distractor candidate; no major automated warning. |
...
| Correlated indicator | Pearson | Spearman | Overlap | Visual similarity | Warning | Notes |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| Unemployment (`SL.UEM.TOTL.ZS`) | 0.93 | 0.91 | 163 | 0.49 | high | Very high correlation can make the pair unfairly ambiguous. Same or closely related topic; use only when the tier calls for close distractors. |
