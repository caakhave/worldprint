...
def main() -> int:
    ...
    print_command("CGY_TARGET=test ./.venv/bin/python -m pytest --html=reports/test.html --self-contained-html")
    print_command("CGY_TARGET=test ./.venv/bin/python -m pytest -m smoke --html=reports/smoke.html --self-contained-html")
    print_command("CGY_TARGET=test ./.venv/bin/python -m pytest -m mobile --html=reports/mobile.html --self-contained-html")
    print_command("CGY_TARGET=test ./.venv/bin/python -m pytest -m auth --html=reports/auth.html --self-contained-html")
    print_command("CGY_TARGET=apex ./.venv/bin/python -m pytest -m prod_smoke --html=reports/prod-smoke.html --self-contained-html")
    print_command("CGY_TARGET=apex ./.venv/bin/python -m pytest --html=reports/apex.html --self-contained-html")
    print_command("CGY_TARGET=www ./.venv/bin/python -m pytest --html=reports/www.html --self-contained-html")
