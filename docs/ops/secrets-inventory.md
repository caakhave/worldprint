...
| `SUPABASE_STAGING_DB_URL` | Yes | Staging SQL validation runner | Export manually only when running staging validation. Prefer the direct connection string over transaction-pooler URLs. Do not print, paste, log, or commit. |
