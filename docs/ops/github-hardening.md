...
- Dependabot verification on July 9, 2026: authenticated read-only GitHub API returned zero open Dependabot alerts, and alert #1 for `GHSA-qx2v-qp2m-jg93` was marked `fixed` after the main lockfile update reached the default branch.
