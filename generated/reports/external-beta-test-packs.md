...
| 4 | Basic drinking water access | `worldprint-safe-drinking-water` | `SH.H2O.BASW.ZS` | Daily-ready | health | intro | 2024 | 162 | 3.75 | Do players understand the hidden-indicator task within 30 seconds? |
...
| # | Map | Round ID | WB code | Status | Category | Difficulty | Year | Coverage | Overall | Watch |
|---:|---|---|---|---|---|---|---:|---:|---:|---|
| 1 | Account ownership | `worldprint-account-ownership` | `FX.OWN.TOTL.ZS` | Daily-ready | development | standard | 2024 | 132 | 3.55 | Do the seven kept Batch 2 Daily maps feel worthy of the main Daily? |
...
| 4 | Open defecation | `worldprint-open-defecation` | `SH.STA.ODFC.ZS` | Daily-ready | health | standard | 2024 | 150 | 3.75 | Do the seven kept Batch 2 Daily maps feel worthy of the main Daily? |
...
| 4 | Urban population growth | `worldprint-urban-population-growth` | `SP.URB.GROW` | Practice-only | settlement | standard | 2025 | 169 | 3.95 | Which maps feel unfair or too close to other known indicators? |
...
| 6 | Carbon intensity of GDP | `worldprint-carbon-intensity-gdp` | `EN.GHG.CO2.RT.GDP.KD` | Expert-only | environment | expert | 2024 | 159 | 3.95 | Which maps feel unfair or too close to other known indicators? |
...
| 3 | Commercial bank branches | `worldprint-bank-branches` | `FB.CBK.BRCH.P5` | Expert-only | connectivity | expert | 2024 | 128 | 3.75 | Do advanced players enjoy harder units and closer choices? |
