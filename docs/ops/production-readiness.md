...
```text
Can You Geo <signin@mail.canyougeo.com>
```
...
Port: 587 or 465
Sender name/address: Can You Geo <signin@mail.canyougeo.com>
```
...
- Create or forward `privacy@canyougeo.com` before public launch.
